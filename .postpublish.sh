...
curl -s -X POST -H 'content-type: application/json' -d "
	{
		\"username\": \"Client Settings\",
		\"icon_url\":\"https://static.janis.in/microservices-v2-logos/janis.png\",
		\"text\": \":package: Versión $PACKAGE_VERSION publicada. <https://github.com/janis-commerce/client-settings/blob/master/CHANGELOG.md|[CHANGELOG]>\"
	}" $SLACK_WEBHOOK
